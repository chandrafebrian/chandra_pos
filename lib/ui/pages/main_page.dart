...
class MainPage extends StatefulWidget {
  ...
  const MainPage({Key? key, this.baruModelMenu, this.pengguna})
      : super(key: key);
...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder(
          stream:
              FirebaseFirestore.instance.collection('collectMenus').snapshots(),
...
//             .collection('collectMenus')
//             .where('userId', isEqualTo: PenggunaBloc().pengguna.userId)
//             .snapshots(),



// ServicesMenu.menuCollection.snapshots(),
